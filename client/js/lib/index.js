            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('canvas', { id: 'viewport', width: '800', height: '600' })
                    )
                ),
                React.createElement(
                    'div',
                    ...
                    React.createElement(
                        ...
                        React.createElement('input', { className: 'login-input', type: 'text', name: 'username' }),
                        ...
                        React.createElement('input', { className: 'login-input', type: 'password', name: 'password' }),
                        React.createElement('br', null),
                        React.createElement('input', { className: 'login-submit', type: 'submit', value: 'Login' })
                    ),
                    React.createElement(
                        'h2',
                        { id: 'login-head' },
                    ...
                    React.createElement(
                        ...
                        React.createElement('input', { className: 'login-input', type: 'password', name: 'password' }),
                        React.createElement('br', null),
                        React.createElement('input', { className: 'login-submit', type: 'submit', value: 'Sign Up' })
                    )
                )
            );
        }
        ...
        render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        this.state.messages.map(message => {
                            if (message.type === 'normal') {
                                ...
                                return React.createElement(
                                    'div',
                                    { className: 'chat-message chat-message-private' },
                                    message.name,
                                    ' to ',
                                    message.recipient,
                                    ': ',
                    ...
                    React.createElement(
                        'form',
                        { id: 'chat-form', onSubmit: this.sendMessage, autoComplete: 'off' },
                        '> ',
                        React.createElement('input', { id: 'chat-input', type: 'text', name: 'message', placeholder: 'Press \'T\' to chat' }),
                        React.createElement('input', { id: 'chat-submit', type: 'submit', value: 'Send' })
                    )
                )
            );
        }
